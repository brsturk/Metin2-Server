...
// DEV NOTE : It was done this way so that the horse's stamina does not go away, you can remove it completely -- 04.04.2025
const int HORSE_HEALTH_DROP_INTERVAL = 365 * 24 * 60 * 60;
const int HORSE_STAMINA_CONSUME_INTERVAL = 365 * 24 * 60 * 60;
const int HORSE_STAMINA_REGEN_INTERVAL = 365 * 24 * 60 * 60;
