...
class LogManager : public singleton<LogManager>
{
	public:
		...
		void		CShieldLog(LPCHARACTER ch, const DWORD errorcode, const bool kickPlayer = true, const TPacketCGHack data = { 0 });
#endif
	...
	private:
		...
		std::unordered_set<DWORD> notificationErrorCodes = ENABLE_LOG_NOTIFICATIONS_ERROR_CODES;
#endif
