...
public:
	...
	static	const bool	IsRamadanMoonRing(DWORD vnum)		{ return 61000 == vnum; }
	static	const bool	IsHalloweenCandy(DWORD vnum)		{ return 61002 == vnum; }
	static	const bool	IsHappinessRing(DWORD vnum)			{ return 84019 == vnum; }
};
