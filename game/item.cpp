		...
		if (GetWindow() != SAFEBOX && GetWindow() != MALL)
		{
			...
			else
			{
				...
				if (!cell.IsDefaultInventoryPosition() && !cell.IsBeltInventoryPosition()
					...
					&& !cell.IsSkillBookInventoryPosition() && !cell.IsUpgradeItemsInventoryPosition() && !cell.IsStoneInventoryPosition() && !cell.IsGiftBoxInventoryPosition()
#endif
					)
				{
...
int CItem::FindEquipCell(LPCHARACTER ch, int iCandidateCell)
{
	...
	else if (GetType() == ITEM_COSTUME)
	{
		...
		else if (GetSubType() == COSTUME_HILAL)
			return WEAR_COSTUME_HILAL;
		else if (GetSubType() == COSTUME_LOLIPOP)
			return WEAR_COSTUME_LOLIPOP;
		else if (GetSubType() == COSTUME_GUC)
			return WEAR_COSTUME_GUC;
		else if (GetSubType() == COSTUME_SEVGI)
			return WEAR_COSTUME_SEVGI;
		else if (GetSubType() == COSTUME_SEVGI2)
			return WEAR_COSTUME_SEVGI2;
		else if (GetSubType() == COSTUME_UYUM)
			return WEAR_COSTUME_UYUM;
#endif
