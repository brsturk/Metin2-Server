...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_CSHIELD_DATA, sizeof(TPacketCGCShieldData), "CShieldData", false);
#ifdef ENABLE_EXTERNAL_REPORTS
	Set(HEADER_CG_CSHIELD_REPORT, sizeof(TPacketCGCShieldReport), "CShieldReport", false);
#endif
#endif
#ifdef ENABLE_CAPTCHA
	Set(HEADER_CG_CAPTCHA, sizeof(TPacketCGCaptcha), "Captcha", false);
#endif
#ifdef ENABLE_DUNGEON_INFO_SYSTEM
	...
	Set(HEADER_CG_NEW_RANKING, sizeof(TDynamicPacketInfo), "NewRanking");
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
	...
	Set(HEADER_CG_STAGE_UPGRADE, sizeof(TPacketCGStageUpgrade), "StageUpGrade", true);
#endif
}
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set(HEADER_GG_CSHIELD_LOG_NOTIFICATION,		sizeof(TPacketGGCShieldLogNotification),	"CShieldLogNotification",	false);
#endif
#ifdef ENABLE_INGAME_ITEMSHOP
