...
// VS EKIPMAN COMMAND
	{ "vs_set",			do_vs_set,		0,	POS_DEAD,		GM_LOW_WIZARD},
	{ "item_vs_set",	do_item_vs_set,	0,	POS_DEAD,		GM_LOW_WIZARD},
	{ "attr_vs_set",	do_attr_vs_set,	0,	POS_DEAD,		GM_LOW_WIZARD},
// VS EKIPMAN COMMAND END
...
#endif
#ifdef ENABLE_DISTANCE_SKILL_SELECT
	{ "distance_skill_select", do_skill_select,	0,	POS_DEAD, GM_PLAYER },
#endif
#ifdef ENABLE_EVENT_MANAGER
	{ "event_manager",	do_event_manager,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_NEW_BIOLOG
	{ "give_biolog",	do_give_biolog,		0,	POS_DEAD,	GM_PLAYER },
	{ "update_biolog",	do_update_biolog,	0,	POS_DEAD,	GM_PLAYER },
	{ "updt_remnder",	do_update_reminder,	0,	POS_DEAD,	GM_PLAYER },
	{ "slct_sppp",		do_select_special,	0,	POS_DEAD,	GM_PLAYER },
	{ "open_biopnl",	do_open_biowindow,	0,	POS_DEAD,	GM_PLAYER },
#endif
#ifdef __ENABLE_NEW_OFFLINESHOP__
