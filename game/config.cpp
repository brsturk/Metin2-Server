...
int		g_aiItemDestroyTime[ITEM_DESTROY_TIME_MAX] = {60, 60, 60}; // autoitem, dropgold, dropitem
...
string		g_stClientVersion = "9896248778";

BYTE		g_bBilling = false;
#ifdef __ENABLE_STAGE_SYSTEM__
bool		test_stage_timer = false;
#endif
...
#ifdef __ENABLE_STAGE_SYSTEM__
		TOKEN("TEST_STAGE_TIMER")
		{
			int flag = 0;
			str_to_number(flag, value_string);
			test_stage_timer = (flag != 0);
		}
#endif
	}
	fclose(fp);
