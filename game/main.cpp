...
#endif
#ifdef ENABLE_NEW_BIOLOG
	CNewBiologManager	biologManager;
#endif
#ifdef ENABLE_ANTI_MULTIPLE_FARM
...
#ifdef ENABLE_AUTO_EVENT_MANAGER
	if (!g_bAuthServer) { EventsManager.Initialize(); }
#endif
#ifdef ENABLE_DUNGEON_INFO_SYSTEM
...
#ifdef ENABLE_CSHIELD
	sys_log(0, "<shutdown> Destroying CShieldManager...");
	CShieldManager.Destroy();
#endif
#ifdef ENABLE_DUNGEON_INFO_SYSTEM
