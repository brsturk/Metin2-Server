...
static const std::unordered_map<uint32_t, std::vector<std::string>> mapItemSubType {
	...
	{28,	{ "COSTUME_BODY", "COSTUME_HAIR", "COSTUME_MOUNT", "COSTUME_WEAPON", "COSTUME_HILAL", "COSTUME_LOLIPOP", "COSTUME_GUC", "COSTUME_SEVGI", "COSTUME_SEVGI2", "COSTUME_UYUM"}},
