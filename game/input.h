...
extern void SendShout(const char* szText, BYTE bEmpire, const char* szCountry, int hyperlinks);
#else
extern void SendShout(const char* szText, BYTE bEmpire);
#endif
...
class CInputMain : public CInputProcessor
{
	...
	protected:
		...
		void		CaptchaReceive(LPCHARACTER ch, const char* c_pData);
#endif
		void		Roulette(LPCHARACTER ch, const char* c_pData);
#ifdef ENABLE_NEW_RANKING_SYSTEM
		int			NewRankingPacket(LPCHARACTER ch, const char * data, size_t uiBytes);
#endif
		...
		void		StageUpgrade(LPCHARACTER ch, const char* c_pData);
#endif
};
...
#ifdef ENABLE_CSHIELD
	void		LoadCShieldData(LPDESC d, const char* data);
#endif
#ifdef ENABLE_NEW_RANKING_SYSTEM
	void		NewRanking(LPDESC d, const char* data);
#endif
...
class CInputP2P : public CInputProcessor
{
	...
	public:
		...
		void		CShieldLogNotification(const char* c_pData);
#endif
